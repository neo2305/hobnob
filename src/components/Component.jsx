...
const Component = () => {
  return (
    <div className="absolute top-[0px] left-[0px] w-full flex flex-col items-start justify-start pt-0 px-0 pb-[10.9px] box-border gap-[22px] h-full z-[8] text-left text-sm text-gray-400 font-roboto">
      <img
      ...
      <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-[244.6px] gap-[45px] mq450:gap-[22px]">
        <div className="w-[240.5px] flex flex-row items-start justify-start py-0 pr-[25px] pl-[24.9px] box-border">
          <div className="flex-1 relative leading-[20px] font-medium whitespace-nowrap shrink-0 z-[3]">
            kikoherrsc@gmail.com
          </div>
        </div>
        <div className="self-stretch flex flex-col items-end justify-start gap-[10.9px] text-gray-200">
          ...
          <div className="self-stretch flex flex-col items-start justify-start text-gray-400">
            <Button
